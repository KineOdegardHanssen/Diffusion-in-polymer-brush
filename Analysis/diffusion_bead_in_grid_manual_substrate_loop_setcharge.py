...
endlocation          = '/Diffusion_bead_near_grid/Spacing'+str(spacing)+'/damp%i_diffseedLgv/Brush/Sigma_bead_' % damp + str(psigma) + '/Charge'+str(charge)+'/'
...
if popup_plots==True:
    ...
    plt.ylabel(r'Distance$^2$ [in unit length]')
    plt.title(r'RMSD in brush, d = %i nm, $\sigma_b=%.2f$, $q$ = %.2f, SI' % (spacing,psigma,charge))
    plt.tight_layout()
    plt.legend(loc='upper left')
...
plt.xlabel(r'Index (s)')
plt.ylabel(r'Distance$^2$ [in unit length]')
plt.title(r'RMSD in brush, d = %i nm, $\sigma_b=%.2f$, $q$ = %.2f' % (spacing,psigma,charge))
plt.tight_layout()
plt.legend(loc='upper left')
...
plt.xlabel(r'Step number')
plt.ylabel(r'Distance$^2$ [in unit length]')
plt.title(r'Averaged RMSD in brush, d = %i nm, $\sigma_b=%.2f$, $q$ = %.2f' % (spacing,psigma,charge))
plt.tight_layout()
plt.legend(loc='upper left')
...
plt.xlabel(r'Step number')
plt.ylabel(r'Distance$^2$ [in unit length]')
plt.title(r'$<dz^2>$ in brush, d = %i nm, $\sigma_b=%.2f$, $q$ = %.2f' % (spacing,psigma,charge))
plt.tight_layout()
...
plt.xlabel(r'Step number')
plt.ylabel(r'Distance$^2$ [in unit length]')
plt.title(r'$<dx^2+dy^2>$ in brush, d = %i nm, $\sigma_b=%.2f$, $q$ = %.2f' % (spacing,psigma,charge))
plt.tight_layout()
...
plt.title(r'Random walk in polymer brush, $\gamma$; d = %i nm, $\sigma_b=%.2f$, $q$ = %.2f' % (spacing,psigma,charge))
plt.tight_layout()
