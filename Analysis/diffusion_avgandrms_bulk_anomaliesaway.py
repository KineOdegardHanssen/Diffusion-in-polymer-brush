...
# Plots
plotname       = endlocation+filestext+'_better_rms_Nestimates%i_compare.png' % Nrms
...
for j in range(Nrms):
    ...
    for k in range(N_per_rms):
        ...
        if long==True:
            infilename_free = endlocation_in+'long/'+'seed'+str(confignr)+'_long.lammpstrj'
        else:
            infilename_free = endlocation_in+'seed'+str(confignr)+'.lammpstrj'
        ...
        try:
            ...
            try:
                infilename_free = endlocation_in+'long/'+'seed'+str(confignr)+'.lammpstrj'
                infile_free = open(infilename_free, "r")
            except:
        ...
        while i<totlines:
            ...
            if (words[0]=='ITEM:'):
                if words[1]=='TIMESTEP':
                    ...
                    times.append(t)
                    i+=skiplines
                elif words[1]=='NUMBER': # These are just safeguards and will never kick in. 
                    i+=1
                elif words[1]=='BOX':
                    i+=1
                elif words[1]=='ATOMS':
    ...
    # Insert interval # These fits are not useful.
