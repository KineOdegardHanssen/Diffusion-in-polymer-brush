...
for j in range(Nrms):
    ...
    # Insert interval
    coeffs_poly, covs = polyfit(times_single_real[startindex_R:endindex_R], averageR2s_SI[startindex_R:endindex_R], 1, full=False, cov=True) # These are not useful anymore
