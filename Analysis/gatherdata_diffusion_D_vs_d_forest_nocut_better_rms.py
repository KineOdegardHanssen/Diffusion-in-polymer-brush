...
outfilename  = endlocation_out+'D_vs_d_forest_better_rms_Nestimates%i.txt' % Nrms
...
outfile.write('d DRs DRs_stdv     Dzs     Dzs_stdv     Dparallel     Dparallel_stdv\n')
...
for i in range(N):
    ...
    infilename = endlocation_in+'diffusion'+filestext+'_better_rms_Nestimates%i.txt' % Nrms
    metaname   = endlocation_in+'diffusion_metadata_'+filestext+'_nocut.txt'
