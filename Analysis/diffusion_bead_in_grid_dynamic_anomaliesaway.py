...
plotname_parallel_orthogonal    = endlocation+'par_ort_'+filestext+'_d'+str(spacing)+'_nocut'  
plotname_parallel_orthogonal_SI = endlocation+'par_ort_'+filestext+'_d'+str(spacing)+'_nocut_SI'  
...
if long==True:
    ...
    plotname_parallel_orthogonal_SI = plotname_parallel_orthogonal_SI+'_long.png'
    ...
    plotname_parallel_orthogonal_SI = plotname_parallel_orthogonal_SI+'.png'
...
for confignr in confignrs:
    ...
    if plotdirs==True:
        ...
        plt.title('Random walk in polymer brush, config %i, d = %.2f nm' % (confignr,spacing))
        plt.tight_layout()
...
if popup_plots==True:
    ...
    plt.ylabel(r'Distance$^2$ [in unit length]')
    plt.title(r'RMSD in brush, d = %.2f nm, $\sigma_b=%.2f$, SI' % (spacing,psigma))
    plt.tight_layout()
    plt.legend(loc='upper left')
...
plt.title('RMSD in brush, d = %.2f nm, SI, sectioning' % spacing)
plt.tight_layout()
plt.legend(loc='upper left')
...
plt.xlabel(r'Step number')
plt.ylabel(r'Distance$^2$ [in unit length]')
plt.title(r'Averaged RMSD in brush, d = %.2f nm, $\sigma_b=%.2f$' % (spacing,psigma))
plt.tight_layout()
plt.legend(loc='upper left')
...
plt.plot(times_single_real, averageR2s_SI, label=r'$<R^2>$')
plt.plot(times_single_real, averagedx2s_SI, label=r'$<dx^2>$')
plt.plot(times_single_real, averagedy2s_SI, label=r'$<dy^2>$')
plt.plot(times_single_real, averagedz2s_SI, label=r'$<dz^2>$')
plt.plot(times_single_real, averagedparallel2_SI, label=r'$<dx^2+dy^2>$')
plt.xlabel(r'Time (s)',fontsize=12)
plt.ylabel(r'Distance$^2$ (m)',fontsize=12)
plt.title(r'Averaged RMSD in brush, d = %.2f nm, $\sigma_b=%.2f$' % (spacing,psigma),fontsize=12)
plt.tight_layout()
plt.legend(loc='upper left',fontsize=12)
plt.savefig(plotname_parallel_orthogonal_SI)
...
plt.xlabel(r'Step number')
plt.ylabel(r'Distance$^2$ [in unit length]')
plt.title(r'$<dx^2+dy^2>$ in brush, d = %.2f nm, $\sigma_b=%.2f$' % (spacing,psigma))
plt.tight_layout()
...
plt.title(r'Random walk in polymer brush, $\gamma$; d = %.2f nm, $\sigma_b=%.2f$' % (spacing,psigma))
plt.tight_layout()
...
plt.title('Averaged velocity in brush, d = %.2f nm' % spacing)
plt.tight_layout()
plt.legend(loc='upper left')
...
plt.title('Averaged velocity in brush, d = %.2f nm, SI' % spacing)
plt.tight_layout()
plt.ticklabel_format(axis='y', style='sci', scilimits=(0,0))
plt.legend(loc='upper left')
