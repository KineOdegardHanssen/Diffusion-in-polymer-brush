...
endlocation          = '/Diffusion_bead_near_grid/Spacing%i/damp%i_diffseedLgv/Pure_bulk/Sigma_bead_' % (spacing,damp)+str(psigma) + '/'
...
plt.figure(figsize=(6,5))
plt.plot(times_single, averageR2s, label=r'$<dR^2>$') 
