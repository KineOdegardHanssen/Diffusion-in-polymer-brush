...
if long==True:
    ...
    spacings = [1,1.25,1.5,2]#[3,4,5,6]#[7,8,10,15]#[25,50,75,100]#[3,4,5,6]#
psigma   = 1
damp     = 10
...
for spacing in spacings:
    ...
    endlocation   = '/Diffusion_bead_near_grid/Spacing'+str(spacing)+'/damp%i_diffseedLgv/' % damp +parentfolder+ 'Sigma_bead_' +str(psigma) + '/Nocut/'
    if cutit==True:
