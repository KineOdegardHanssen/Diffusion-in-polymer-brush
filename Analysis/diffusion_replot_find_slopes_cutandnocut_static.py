...
endlocation_cut     = '/Diffusion_staticbrush/Spacing'+str(spacing)+'/Radius'+str(psigma) + '/'
endlocation_nocut   = endlocation_cut + 'Nocut/'
endlocation_cut     = endlocation_cut + 'Results/'
filestext           = 'config'+str(confignrs[0])+'to'+str(confignrs[-1])+'_placements'+str(bnrs[0])+'to'+str(bnrs[-1])

# Text files
infilename_ds_nocut = endlocation_nocut+'av_ds_'+filestext
