...
outfilename  = endlocation_out+'D_vs_sigma_better_rms_Nestimates%i.txt' % Nintervals
plotname     = endlocation_out+'D_vs_sigma_bulk_better_rms_Nestimates%i.png' % Nintervals
plotname_two = endlocation_out+'D_vs_sigma_bulk_better_rms_Nestimates%i_twoinone.png' % Nintervals
plotname_fit = endlocation_out+'D_vs_sigma_fit_better_rms_Nestimates%i.png' % Nintervals
indfilename  = endlocation_out+'D_vs_sigma_fitindices_better_rms_Nestimates%i.txt' % Nintervals
...
ax1.set_title('a)', y=1.05, loc='left')
...
ax2.loglog(psigmas, theory_graph, '--', label=r'A$\sigma_{\mathregular{LJ}}^{b}$')
ax2.loglog(psigmas, theoryend_graph, '--', label=r'A$\sigma_{\mathregular{LJ}}^{b}$')
ax2.set_xlabel(xlabel=r'$\sigma_{\mathregular{LJ}}$ (nm)',labelpad=-1.5)
ax2.set_ylabel(ylabel=r'$D$ (m$^2$/s)',labelpad=-5)
ax2.legend(loc='lower left')
ax2.set_title('b)', y=1.05, loc='left')
...
print('Exponent, from fit:',b)
print('-------------')
print('Fit performed on: sigma=',psigmas[-3:])
print('Exponent, from fit:',bend)
