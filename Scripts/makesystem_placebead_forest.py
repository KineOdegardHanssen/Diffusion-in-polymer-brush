...
substr_tol = 1.1 # the closest we'll allow the bead to be to the substrate
distrange  = 0.5  # The spread of z-values of the bead. E.g. from 0.5 to 1.5. Will be from substr_tol to substr_tol+distrange.
...
foldername  = '/Diffusion_forest/Initial_configurations/Spacing%i/' % spacing
outfilename = 'data.bead_forest_N909_d%i_charge%i_mass1_file' % (spacing,charge)

infilename = 'data.chaingrids_substrate_N909_Nchains9_Ly3_gridspacing%i_twofixed_charge%i_mass1' % (spacing, charge)
