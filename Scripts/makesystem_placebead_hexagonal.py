...
foldername  = '/Diffusion_bead_near_grid/Initial_configurations/Spacing'+str(spacing)+'/Sigma_bead_1/Hexagonal/'
outfilename = 'data.bead_wsubstr_hex_eq_N808_d'+str(spacing)+'_charge%i_mass1_file' % charge

infilename = 'data.hexatethered_substrate_N808_Nchains8_gridspacing'+str(spacing)+'_twofixed_charge%i_mass1_equilibrated' % charge
