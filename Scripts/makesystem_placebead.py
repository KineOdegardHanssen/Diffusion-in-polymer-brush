...
startlines = 23 # The number of lines we are going to read from the data.-infile and write to the data.-outfile automatic
...
foldername  = '/Diffusion_bead_near_grid/Initial_configurations/Spacing%i/' % spacing
